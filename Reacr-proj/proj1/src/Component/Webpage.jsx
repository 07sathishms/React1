...
function Webpage() {
  ...
  return (
    <div className='Web'>
        ...
        <h1>Moose video...</h1>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/jbUcJm9vAmo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
    </div>
  );
}
